...
<div class="header-right">
	...
	<div class="menu">
		...
		<br>
		<ul>
			<li><a href="../../front/login"><button class="btn btn-3 btn-3e icon-arrow-center">Login</button></a></li>
			<br>
...
<div class="header-left">
		<section>
				<ul class="lb-album">
					<li>
						<a href="#image-1">
							<img src="../resources/images/thumbs/1.jpg" alt="image01">
							<span>Pointe</span>
						</a>
						<div class="lb-overlay" id="image-1">
							<a href="#page" class="lb-close">x Close</a>
							<img src="../resources/images/full/1.jpg" alt="image01" />
							<div>
					...
					<li>
						<a href="#image-2">
							<img src="../resources/images/thumbs/2.jpg" alt="image02">
							<span>Port de bras</span>
						</a>
						<div class="lb-overlay" id="image-2">
							<img src="../resources/images/full/2.jpg" alt="image02" />
							<div>							
					...
					<li>
						<a href="#image-3">
							<img src="../resources/images/thumbs/3.jpg" alt="image03">
							<span>Plié</span>
						</a>
						<div class="lb-overlay" id="image-3">
							<img src="../resources/images/full/3.jpg" alt="image03" />
							<div>							
					...
					<li>
						<a href="#image-4">
							<img src="../resources/images/thumbs/4.jpg" alt="image04">
							<span>Adagio</span>
						</a>
						<div class="lb-overlay" id="image-4">
							<img src="../resources/images/full/4.jpg" alt="image04" />
							<div>							
					...
					<li>
						<a href="#image-5">
							<img src="../resources/images/thumbs/5.jpg" alt="image05">
							<span>Frappé</span>
						</a>
						<div class="lb-overlay" id="image-5">
							<img src="../resources/images/full/5.jpg" alt="image05" />
							<div>							
					...
					<li>
						<a href="#image-6">
							<img src="../resources/images/thumbs/6.jpg" alt="image06">
							<span>Glissade</span>
						</a>
						<div class="lb-overlay" id="image-6">
							<img src="../resources/images/full/6.jpg" alt="image06" />
							<div>							
					...
					<li>
						<a href="#image-7">
							<img src="../resources/images/thumbs/7.jpg" alt="image07">
							<span>Jeté</span>
						</a>
						<div class="lb-overlay" id="image-7">
							<img src="../resources/images/full/7.jpg" alt="image07" />
							<div>							
					...
					<li>
						<a href="#image-8">
							<img src="../resources/images/thumbs/8.jpg" alt="image08">
							<span>Piqué</span>
						</a>
						<div class="lb-overlay" id="image-8">
							<img src="../resources/images/full/8.jpg" alt="image08" />
							<div>							
					...
					<li>
						<a href="#image-9">
							<img src="../resources/images/thumbs/9.jpg" alt="image09">
							<span>Arabesque</span>
						</a>
						<div class="lb-overlay" id="image-9">
							<img src="../resources/images/full/9.jpg" alt="image09" />
							<div>							
					...
					<li>
						<a href="#image-10">
							<img src="../resources/images/thumbs/10.jpg" alt="image10">
							<span>Ballerina</span>
						</a>
						<div class="lb-overlay" id="image-10">
							<img src="../resources/images/full/10.jpg" alt="image10" />
							<div>							
					...
					<li>
						<a href="#image-11">
							<img src="../resources/images/thumbs/11.jpg" alt="image10">
							<span>Ballerina</span>
						</a>
						<div class="lb-overlay" id="image-11">
							<img src="../resources/images/full/11.jpg" alt="image10" />
							<div>							
								<h3>bal·le·ri·na <span>/ˌbaləˈrēnə/</h3>
								<p>A female ballet dancer</p>
							</div>
							<a href="#page" class="lb-close">x Close</a>
										...
										<li>
						<a href="#image-12">
							<img src="../resources/images/thumbs/12.jpg" alt="image10">
							<span>Ballerina</span>
						</a>
						<div class="lb-overlay" id="image-12">
							<img src="../resources/images/full/12.jpg" alt="image10" />
							<div>							
								<h3>bal·le·ri·na <span>/ˌbaləˈrēnə/</h3>
								<p>A female ballet dancer</p>
							</div>
...
<div class="main">
	...
	<div class="blog-img">
	  ...
	  <div class="blog-text">
          <a href="#" class="link4">Choi DaHui</a><br>
          <span class="color1">Korea </span><br>
          <a href="#" class="color2">production date</a> / <a href="#" class="color2">2020/12/14</a><br>
          <span class="link-top">completed: <a href="#" class="color2">30%</a> </span> 
      </div>
	<div class="clear"></div>
	</div>
	<div class="readmore">
